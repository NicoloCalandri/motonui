...
export default function LandingClient() {
    ...
    return (
        <div className="min-h-screen bg-white flex flex-col font-sans">
            {/* Top Navigation */}
            <header className="h-20 bg-white border-b border-neutral-100 flex items-center justify-between px-8 z-50 sticky top-0">
                ...
                <section className="relative py-20 lg:py-32 px-8 overflow-hidden">
                    <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12 relative z-10">
                        <div className="flex-1 text-center lg:text-left">
                            ...
                            {error && (
                                <div className="mb-6 p-4 bg-red-50 text-red-600 rounded-xl text-sm font-medium border border-red-100 inline-block w-full max-w-md">
                                    {error}
                                </div>
                            )}
                            ...
                            <button
                                onClick={handleGoogle}
                                disabled={loading}
                                className="w-full sm:w-auto px-8 py-4 bg-indigo-600 text-white rounded-2xl font-bold text-lg hover:bg-indigo-700 transition-all shadow-lg hover:shadow-indigo-600/30 flex items-center justify-center gap-3"
                            >
                                {loading ? (
                            ...
                            <div className="relative rounded-3xl overflow-hidden shadow-2xl bg-neutral-900 aspect-[4/3] transform lg:rotate-2 hover:rotate-0 transition-transform duration-500">
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-neutral-900/80 to-transparent flex flex-col justify-end p-8">
                                    <div className="bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-2xl flex items-center gap-4">
                                        ...
                                        <div>
                                            <div className="text-white font-bold">Volo per Bali</div>
                                            <div className="text-white/70 text-sm">Partenza tra 2 giorni</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            {/* Footer */}
            <footer className="bg-neutral-900 py-12 px-8 text-neutral-400">
